...
#' The function is used internally by \code{\link{import_session2}}
#'
#' @param dat a dataframe returned by \code{\link{get_iox}}.
...
#' @importFrom rlang .data
#' @export
import_session2 <- function(iox_folder, baseline = 30, inter = TRUE, comments_tsd, tofill = NULL){
